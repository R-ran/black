      ...
      <main className="page-container">
        <div className="page-content">
          ...
          <div className="policy-content">
            <h2>OVERVIEW</h2>
            <p>
              This website is operated by tinymintstore. Throughout the site,
              the terms "we", "us" and "our" refer to tinymintstore. Tinymintstore
            ...
            <p>
              ...
              our{" "}
              <Link href="/return-refund-policy" className="contact-link">
                Return Policy
              </Link>
              .
            </p>
            ...
            <p>
              ...
              or other personal or proprietary right. You further agree that your
            ...
            <p>
              ...
              or the Internet; (h) to collect or track the personal information
              of others; (i) to spam, phish, pharm, pretext, spider, crawl, or
            ...
            <p>
              In no case shall tinymintstore, our directors, officers, employees,
            ...
            <p>
              You agree to indemnify, defend and hold harmless tinymintstore and
